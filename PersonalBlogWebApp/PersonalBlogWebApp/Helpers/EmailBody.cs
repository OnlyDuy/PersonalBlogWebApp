namespace PersonalBlogWebApp.Helpers
{
                ...
                <div style=""height: auto;background: linear-gradient(to top, #c9c9ff 50%, #6e6ef6 90%) no-repeat;width:400px; padding : 30px"">
                    <div>
                        <div>
                            ...
                            color:white;border-radius:4px;display:block;margin:@ auto;width:50%; text-align:center;text-decoration:none"">Reset Password</a><br>
